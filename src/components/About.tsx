      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {[
            ...
            { icon: Award, label: 'Confianza', value: '50+ Clientes' }
          ].map((item, index) => {
            const IconComponent = item.icon;
            return (
              <div
                key={index}
                className="p-8 bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] text-center"
              >
        ...
        <div className="relative">
          ...
          <div className="relative bg-slate-900/70 backdrop-blur-xl rounded-3xl p-12 border border-blue-500/30">
